...
[Example](examples/handshake.json)
...
### lost_password[​](#lost_password "Direct link to lost_password")
...
## Non-Data Methods[​](#non-data-methods "Direct link to Non-Data Methods")

These methods take no parameters beyond your auth key to return information

### system_update[​](#system_update "Direct link to system_update")
...
[Example](examples/system_update.json)

### system_preferences[​](#system_preferences "Direct link to system_preferences")
...
[Example](examples/system_preferences.json)
...
[Example](examples/users.json)

### user_preferences[​](#user_preferences "Direct link to user_preferences")
...
[Example](examples/user_preferences.json)

## Data Methods[​](#data-methods "Direct link to Data Methods")

Data methods require additional information and parameters to return information

### advanced_search[​](#advanced_search "Direct link to advanced_search")
...
| rule\_\* | array | \[`rule_1`, `rule_1_operator`, `rule_1_input`\] | NO |
| rule\_\* | array | \[`rule_2`, `rule_2_operator`, `rule_2_input`\], \[etc\] | YES |
...
SONG [Example](examples/advanced_search_song.json)

ARTIST [Example](examples/advanced_search_artist.json)

ALBUM [Example](examples/advanced_search_album.json)
...
### album_disks[​](#album_disks "Direct link to album_disks")
...
### album_disk[​](#album_disk "Direct link to album_disk")
...
### album_disk_songs[​](#album_disk_songs "Direct link to album_disk_songs")
...
### artists[​](#artists "Direct link to artists")
...
### bookmarks[​](#bookmarks "Direct link to bookmarks")
...
[Example](examples/bookmarks.json) [Example (with include)](examples/bookmarks_with_include.json)
...
[Example](examples/bookmark.json) [Example (with include)](examples/bookmark_with_include.json)

### bookmark_create[​](#bookmark_create "Direct link to bookmark_create")
...
[Example](examples/bookmark_create.json)

### bookmark_delete[​](#bookmark_delete "Direct link to bookmark_delete")
...
[Example](examples/bookmark_delete.json)

### bookmark_edit[​](#bookmark_edit "Direct link to bookmark_edit")
...
[Example](examples/bookmark_edit.json)
...
[Example](examples/browse_root.json)

[Example: music catalog](examples/browse_music_catalog.json)

[Example: podcast catalog](examples/browse_podcast_catalog.json)

[Example: video catalog](examples/browse_video_catalog.json)

[Example: artist](examples/browse_artist.json)

[Example: album](examples/browse_album.json)

[Example: podcast](examples/browse_podcast.json)
...
[Example](examples/catalogs.json)
...
[Example](examples/catalog.json)

### catalog_action[​](#catalog_action "Direct link to catalog_action")
...
[Example: clean_catalog](examples/catalog_action_clean_catalog.json)

[Example: add_to_catalog](examples/catalog_action_add_to_catalog.json)

### catalog_add[​](#catalog_add "Direct link to catalog_add")
...
[Example](examples/catalog_create.json)

### catalog_delete[​](#catalog_delete "Direct link to catalog_delete")
...
[Example](examples/catalog_delete.json)

### catalog_file[​](#catalog_file "Direct link to catalog_file")
...
[Example](examples/catalog_file.json)

### catalog_folder[​](#catalog_folder "Direct link to catalog_folder")
...
[Example](examples/catalog_folder.json)
...
### collection_items[​](#collection_items "Direct link to collection_items")
...
### collection_create[​](#collection_create "Direct link to collection_create")
...
### collection_edit[​](#collection_edit "Direct link to collection_edit")
...
#### Reordering[​](#reordering "Direct link to Reordering")
...
### collection_delete[​](#collection_delete "Direct link to collection_delete")
...
### collection_add[​](#collection_add "Direct link to collection_add")
...
### collection_remove[​](#collection_remove "Direct link to collection_remove")
...
### deleted_podcast_episodes[​](#deleted_podcast_episodes "Direct link to deleted_podcast_episodes")
...
[Example](examples/deleted_podcast_episodes.json)

### deleted_songs[​](#deleted_songs "Direct link to deleted_songs")
...
[Example](examples/deleted_songs.json)

### deleted_videos[​](#deleted_videos "Direct link to deleted_videos")
...
[Example](examples/deleted_videos.json)
...
[Example](examples/followers.json)

### following[​](#following "Direct link to following")
...
[Example](examples/following.json)

### friends_timeline[​](#friends_timeline "Direct link to friends_timeline")
...
[Example](examples/friends_timeline.json)

### genres[​](#genres "Direct link to genres")
...
[Example](examples/genre.json)

### genre_albums[​](#genre_albums "Direct link to genre_albums")
...
[Example](examples/genre_albums.json)

### genre_artists[​](#genre_artists "Direct link to genre_artists")
...
[Example](examples/genre_artists.json)

### genre_songs[​](#genre_songs "Direct link to genre_songs")
...
[Example](examples/genre_songs.json)

### get_bookmark[​](#get_bookmark "Direct link to get_bookmark")
...
[Example](examples/get_bookmark.json) [Example (with include)](examples/get_bookmark_with_include.json)

### get_external_metadata[​](#get_external_metadata "Direct link to get_external_metadata")
...
[Example](examples/get_external_metadata.json)

### get_indexes[​](#get_indexes "Direct link to get_indexes")
...
SONG [Example](examples/get_indexes_song.json)

ARTIST [Example](examples/get_indexes_artist.json)

ALBUM [Example](examples/get_indexes_album.json)

PLAYLIST [Example](examples/get_indexes_playlist.json)

### get_lyrics[​](#get_lyrics "Direct link to get_lyrics")
...
[Example](examples/get_lyrics.json)

### get_similar[​](#get_similar "Direct link to get_similar")
...
[Example](examples/get_similar.json)
...
SONG [Example](examples/index_song.json)

ARTIST [Example](examples/index_artist.json)

ALBUM [Example](examples/index_album.json)

PLAYLIST [Example](examples/index_playlist.json)

SONG [Example (with include)](examples/index_song_with_include.json)

ARTIST [Example (with include)](examples/index_artist_with_include.json)

ALBUM [Example (with include)](examples/index_album_with_include.json)

PLAYLIST [Example (with include)](examples/index_playlist_with_include.json)
...
[Example](examples/label.json)

### label_artists[​](#label_artists "Direct link to label_artists")
...
[Example](examples/label_artists.json)

### last_shouts[​](#last_shouts "Direct link to last_shouts")
...
[Example](examples/last_shouts.json)
...
[Example](examples/licenses.json)
...
[Example](examples/license.json)

### license_songs[​](#license_songs "Direct link to license_songs")
...
[Example](examples/license_songs.json)
...
[Example](examples/list.json)

### live_streams[​](#live_streams "Direct link to live_streams")
...
[Example](examples/live_streams.json)

### live_stream[​](#live_stream "Direct link to live_stream")
...
[Example](examples/live_stream.json)

### live_stream_create[​](#live_stream_create "Direct link to live_stream_create")
...
[Example](examples/live_stream_create.json)

### live_stream_delete[​](#live_stream_delete "Direct link to live_stream_delete")
...
[Example](examples/live_stream_delete.json)

### live_stream_edit[​](#live_stream_edit "Direct link to live_stream_edit")
...
[Example](examples/live_stream_edit.json)

### now_playing[​](#now_playing "Direct link to now_playing")
...
[Example](examples/now_playing.json)
...
### playlist_add[​](#playlist_add "Direct link to playlist_add")
...
[Example](examples/playlist_add.json)

### playlist_add_song[​](#playlist_add_song "Direct link to playlist_add_song")
...
[Example](examples/playlist_add_song.json)

### playlist_create[​](#playlist_create "Direct link to playlist_create")
...
[Example](examples/playlist_create.json)

### playlist_delete[​](#playlist_delete "Direct link to playlist_delete")
...
[Example](examples/playlist_delete.json)

### playlist_edit[​](#playlist_edit "Direct link to playlist_edit")
...
[Example](examples/playlist_edit.json)

### playlist_generate[​](#playlist_generate "Direct link to playlist_generate")
...
SONG [Example](examples/playlist_generate_song.json)

INDEX [Example](examples/playlist_generate_index.json)

ID [Example](examples/playlist_generate_id.json)

### playlist_hash[​](#playlist_hash "Direct link to playlist_hash")
...
[Example](examples/playlist_hash.json)

### playlist_remove[​](#playlist_remove "Direct link to playlist_remove")
...
[Example](examples/playlist_remove.json)
...
### podcasts[​](#podcasts "Direct link to podcasts")
...
[Example](examples/podcasts.json)

### podcast[​](#podcast "Direct link to podcast")
...
[Example](examples/podcast.json)

### podcast_create[​](#podcast_create "Direct link to podcast_create")
...
[Example](examples/podcast_create.json)

### podcast_delete[​](#podcast_delete "Direct link to podcast_delete")
...
[Example](examples/podcast_delete.json)

### podcast_edit[​](#podcast_edit "Direct link to podcast_edit")
...
[Example](examples/podcast_edit.json)

### podcast_episodes[​](#podcast_episodes "Direct link to podcast_episodes")
...
[Example](examples/podcast_episodes.json)

### podcast_episode[​](#podcast_episode "Direct link to podcast_episode")
...
[Example](examples/podcast_episode.json)

### podcast_episode_delete[​](#podcast_episode_delete "Direct link to podcast_episode_delete")
...
[Example](examples/podcast_episode_delete.json)

### preference_create[​](#preference_create "Direct link to preference_create")
...
[Example](examples/preference_create.json)

### preference_delete[​](#preference_delete "Direct link to preference_delete")
...
[Example](examples/preference_delete.json)

### preference_edit[​](#preference_edit "Direct link to preference_edit")
...
[Example](examples/preference_edit.json)
...
### record_play[​](#record_play "Direct link to record_play")
...
[Example](examples/record_play.json)

### scrobble[​](#scrobble "Direct link to scrobble")
...
[Example](examples/scrobble.json)
...
### search_group[​](#search_group "Direct link to search_group")
...
ALL [Example](examples/search_group_all.json)

MUSIC [Example](examples/search_group_music.json)

PODCAST [Example](examples/search_group_podcast.json)

### search_rules[​](#search_rules "Direct link to search_rules")
...
Artist [Example](examples/search_rules_artist.json)

Album [Example](examples/search_rules_album.json)

Song [Example](examples/search_rules_song.json)

### search_songs[​](#search_songs "Direct link to search_songs")
...
[Example](examples/search_songs.json)

### shares[​](#shares "Direct link to shares")
...
[Example](examples/share.json)

### share_create[​](#share_create "Direct link to share_create")
...
[Example](examples/share_create.json)

### share_delete[​](#share_delete "Direct link to share_delete")
...
[Example](examples/share_delete.json)

### share_edit[​](#share_edit "Direct link to share_edit")
...
[Example](examples/share_edit.json)

### smartlists[​](#smartlists "Direct link to smartlists")
...
[Example](examples/smartlists.json)

### smartlist[​](#smartlist "Direct link to smartlist")
...
[Example](examples/smartlist.json)

### smartlist_songs[​](#smartlist_songs "Direct link to smartlist_songs")
...
[Example](examples/smartlist_songs.json)

### smartlist_delete[​](#smartlist_delete "Direct link to smartlist_delete")
...
[Example](examples/smartlist_delete.json)
...
### song_delete[​](#song_delete "Direct link to song_delete")
...
[Example](examples/song_delete.json)

### song_tags[​](#song_tags "Direct link to song_tags")
...
[Example](examples/song_tags.json)

### sonic_match[​](#sonic_match "Direct link to sonic_match")
...
### system_preference[​](#system_preference "Direct link to system_preference")
...
[Example](examples/timeline.json)

### toggle_follow[​](#toggle_follow "Direct link to toggle_follow")
...
[Example](examples/toggle_follow.json)

### update_art[  ​](#update_art "Direct link to update_art")
...
[Example](examples/update_art.json)

### update_artist_info[​](#update_artist_info "Direct link to update_artist_info")
...
[Example](examples/update_artist_info.json)

### update_from_tags[​](#update_from_tags "Direct link to update_from_tags")
...
[Example](examples/update_from_tags.json)

### update_podcast[​](#update_podcast "Direct link to update_podcast")
...
[Example](examples/update_podcast.json)
...
### url_to_song[​](#url_to_song "Direct link to url_to_song")
...
[Example](examples/url_to_song.json)
...
### user_create[​](#user_create "Direct link to user_create")
...
[Example](examples/user_create.json)

### user_delete[​](#user_delete "Direct link to user_delete")
...
[Example](examples/user_delete.json)

### user_edit[​](#user_edit "Direct link to user_edit")
...
[Example](examples/user_edit.json)

### user_playlists[​](#user_playlists "Direct link to user_playlists")
...
[Example](examples/user_playlists.json)

### user_preference[​](#user_preference "Direct link to user_preference")
...
[Example](examples/user_preference.json)

### user_smartlists[​](#user_smartlists "Direct link to user_smartlists")
...
[Example](examples/user_smartlists.json)
...
[Example](examples/video.json)

## Binary Data Methods[​](#binary-data-methods "Direct link to Binary Data Methods")
...
### get_art[​](#get_art "Direct link to get_art")
...
### democratic[​](#democratic "Direct link to democratic")
...
[Example](examples/democratic_play.json)

[Example](examples/democratic_vote.json)

[Example](examples/democratic_playlist.json)

### localplay[​](#localplay "Direct link to localplay")
...
[Example](examples/localplay.json)

[Example (status)](examples/localplay_status.json)

### localplay_songs[​](#localplay_songs "Direct link to localplay_songs")
...
[Example](examples/localplay_songs.json)

## Shared reference objects[​](#shared-reference-objects "Direct link to Shared reference objects")
...
### CollectionItemObject[​](#collectionitemobject "Direct link to CollectionItemObject")
...
### FolderBrowseItem[​](#folderbrowseitem "Direct link to FolderBrowseItem")
...
### FolderBrowseNode[​](#folderbrowsenode "Direct link to FolderBrowseNode")
...
### GenreReference[​](#genrereference "Direct link to GenreReference")
...
### IndexReferenceObject[​](#indexreferenceobject "Direct link to IndexReferenceObject")
...
### LocalplayStatusObject[​](#localplaystatusobject "Direct link to LocalplayStatusObject")
...
### NamedReference[​](#namedreference "Direct link to NamedReference")
...
### PlaylistFolderItemObject[​](#playlistfolderitemobject "Direct link to PlaylistFolderItemObject")
